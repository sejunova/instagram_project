    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img_profile', models.ImageField(blank=True, upload_to='user', verbose_name='이미지 업로드')),
                ('age', models.PositiveIntegerField(null=True, verbose_name='나이')),
                ('nickname', models.CharField(blank=True, max_length=20, unique=True)),
                ('user_type', models.CharField(choices=[('USER_TYPE_FACEBOOK', 'Facebook'), ('USER_TYPE_CHOICES', 'Django')], max_length=1)),
            ],
            options={
                'verbose_name': '사용자 이름',
                'verbose_name_plural': '사용자 이름 목록',
            },
            managers=[
